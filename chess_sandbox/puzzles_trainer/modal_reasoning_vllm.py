"""Modal vLLM inference endpoint for chess reasoning LoRA model.

Deploy:
    modal deploy chess_sandbox/puzzles_trainer/modal_reasoning_vllm.py

Serve locally (for testing):
    modal serve chess_sandbox/puzzles_trainer/modal_reasoning_vllm.py

Usage:
    curl https://your-workspace--chess-reasoning-vllm-serve.modal.run/v1/chat/completions \
        -H "Content-Type: application/json" \
        -d '{"model": "chess-reasoning", "messages": [{"role": "user", "content": "..."}], "max_tokens": 1024}'
"""
...
LORA_ADAPTER = "pilipolio/chess-reasoning-sft-qwen3-4b"
VLLM_PORT = 8000
...
app = modal.App("chess-reasoning-vllm", image=vllm_image)
